        ...
        <table style="width: 100%; border: none; margin-bottom: 20px;">
            <tr>
                <td style="width: 50%; border: none; vertical-align: top;">
                    <img src="{{ public_path('images/app-logo-v2.png') }}" alt="Logo"
        ...
        <table class="bordered-table" style="width: 100%; margin-bottom: 10px;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 30%; text-align: left;">{{ $quotation->reference }}</td>
                    <th style="width: 20%; text-align: left; background-color: #f5f5f5;">Status</th>
                    <td style="width: 30%; text-align: left;">{{ $quotation->status }}</td>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #f5f5f5;">Client Name</th>
                    <td>{{ $quotation->customer->name }}</td>
                    <th style="text-align: left; background-color: #f5f5f5;">Event Type</th>
                    <td>{{ $quotation->eventType->name }}</td>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #f5f5f5;">Mobile No.</th>
                    <td>{{ $quotation->customer->mobile }}</td>
                    <th style="text-align: left; background-color: #f5f5f5;">Event Date</th>
                    <td>{{ $quotation->event_time ? \Carbon\Carbon::parse($quotation->event_time)->format('d/m/Y') : '' }}
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #f5f5f5;">Event For</th>
                    <td>{{ $quotation->event_for }}</td>
                    <th style="text-align: left; background-color: #f5f5f5;">Event Time</th>
                    <td>{{ $quotation->event_time ? \Carbon\Carbon::parse($quotation->event_time)->format('h:i A') : '' }}
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left; background-color: #f5f5f5;">Total Pax</th>
                    <td>{{ $quotation->total_pax }}</td>
                    <th style="text-align: left; background-color: #f5f5f5;">Created at</th>
                    <td>{{ \Carbon\Carbon::parse($quotation->created_at)->format('d/m/Y h:i A') }}</td>
                </tr>
            </tbody>
        </table>
            ...
            <tr>
                <td style="width: 70%; border: none; vertical-align: top;">
                    ...
                    <div style="font-size: 11px; line-height: 1.6;">
                        {!! $quotation->note ?? '<p>No notes available</p>' !!}
                    </div>
                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    {{ format_currency($quotation->sub_total) }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    {{ format_currency($quotation->total_discount_amount) }}
                                </td>
                            </tr>
                            <tr>
                                <th style="text-align: left;">Advance</th>
                                <td style="text-align: right;">
                                    {{ format_currency($quotation->advance_paid) }}
                                </td>
                            </tr>
                            <tr class="total-row">
                            ...
                            <tr class="total-row">
                                ...
                                <td style="text-align: right;">
                                    {{ format_currency($quotation->total - $quotation->advance_paid) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
