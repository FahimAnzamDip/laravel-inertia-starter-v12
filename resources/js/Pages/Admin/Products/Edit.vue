...
const form = useForm({
    ...
    product_type: parseInt(props.product.product_type) || 1,
    cost: props.product.cost,
    quantity: props.product.quantity,
    alert_quantity: props.product.alert_quantity,
    unit_id: props.product.unit_id,
    tax_id: props.product.tax_id,
    duration_in_minutes: props.product.duration_in_minutes,
...
let savedImages = ref([]);
let imagePaths = ref(props.media_urls);

console.log(props.media_urls);
