        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow">
                <div class="card-header d-flex flex-wrap justify-content-end">
                    ...
                    <a :href="route('event-sales.print', sale.id)" target="_blank" class="btn btn-tertiary ms-2 btn-sm">
                        <i class="ri-printer-line"></i>
                        <span class="ms-2">Print</span>
                    </a>
                    <a :href="route('event-sales.pdf', sale.id)" target="_blank" class="btn btn-tertiary ms-2 btn-sm">
                            ...
                            <table class="table table-centered table-bordered table-nowrap mb-0 rounded">
                                <tbody>
                                    ...
                                    <tr class="thead-light">
                                        ...
                                        <th class="text-left align-middle py-2">Event Type</th>
                                        <td class="text-left align-middle py-2">
                                            {{ sale.event_type?.name ?? '-----' }}
                                        </td>
                                    </tr>
                                    <tr class="thead-light">
                                        ...
                                        <th class="text-left align-middle py-2">Event Date</th>
                                        <td class="text-left align-middle py-2">
                                            {{ formatDateTime(sale.event_time, 'DD/MM/YYYY', 'date') }}
                                        </td>
                                    </tr>
                                    <tr class="thead-light">
                                        <th class="text-left align-middle py-2">Event For</th>
                                        <td class="text-left align-middle py-2">
                                            {{ sale.event_for ?? '-----' }}
                                        </td>
                                        <th class="text-left align-middle py-2">Event Time</th>
                                        <td class="text-left align-middle py-2">
                                            {{ formatDateTime(sale.event_time, 'H:mm A', 'time') }}
                                        </td>
                                    </tr>
                                    <tr class="thead-light">
                                        <th class="text-left align-middle py-2">Total Pax</th>
                                        <td class="text-left align-middle py-2">
                                            {{ sale.total_pax ?? '-----' }}
                                        </td>
