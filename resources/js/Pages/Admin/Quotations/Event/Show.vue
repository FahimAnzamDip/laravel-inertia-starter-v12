...
const openPdf = () => {
    const url = route('event-quotations.pdf', props.quotation.id);
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow">
                <div class="card-header d-flex flex-wrap justify-content-end">
                    <a
                        :href="route('event-quotations.print', quotation.id)"
                        target="_blank"
                            ...
                            <table class="table table-centered table-bordered table-nowrap mb-0 rounded">
                                <tbody>
                                    ...
                                    <tr class="thead-light">
                                        ...
                                        <td class="text-left align-middle py-2">
                                            {{ formatDateTime(quotation.event_time, 'DD/MM/YYYY', 'date') }}
                                        </td>
                                    </tr>
                                    <tr class="thead-light">
                                        ...
                                        <td class="text-left align-middle py-2">
                                            {{ formatDateTime(quotation.event_time, 'H:mm A', 'time') }}
                                        </td>
                                    </tr>
                                    <tr class="thead-light">
