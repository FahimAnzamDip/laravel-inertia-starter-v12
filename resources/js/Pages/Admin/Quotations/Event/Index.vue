...
const { currentRow, formatCurrency, formatDateTime, formatRangePicker } = useHelpers();
...
let params = reactive({
    ...
    field: props.filters.field ?? 'event_time',
...
<template>
    ...
    <Breadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Event Quotations</li>
    </Breadcrumb>
    <!-- Breadcrumb End -->
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3 mb-md-0">
                            <Link
                                ...
                                :href="route('quotations.create', { type: 'event' })"
                                class="btn btn-primary"
                            >
                                Add Event Quotation <i class="ri-add-line"></i>
                            </Link>
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th
                                        @click="sort('event_time')"
                                        class="border-0 text-center align-middle cursor-pointer d-flex align-items-center justify-content-center"
                                    >
                                        <span class="me-2">Event Time</span>
                                        <span v-if="params.field === 'event_time' && params.direction === 'asc'"
                                            ><i class="ri-sort-asc text-secondary"></i
                                        ></span>
                                        <span v-if="params.field === 'event_time' && params.direction === 'desc'"
                            ...
                            <tbody>
                                ...
                                <tr v-for="(quotation, index) in quotations.data" :key="quotation.id">
                                    ...
                                    <td class="text-center align-middle">
                                        {{ formatDateTime(quotation.event_time) }}
                                    </td>
                                    <td class="text-center align-middle">
                                        <Link
                                            :href="route('event-quotations.show', quotation)"
                                        ...
                                        <Link
                                            v-if="quotation.sale"
                                            :href="route('event-sales.show', quotation.sale?.id)"
